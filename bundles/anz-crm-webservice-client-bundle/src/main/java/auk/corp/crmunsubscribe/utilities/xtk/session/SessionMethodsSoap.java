...
public interface SessionMethodsSoap {
     ...
     * @param pstrSecurityToken
     * @param sessiontoken
     * @param strBearerToken
     * @param pstrSessionToken
     */
    @WebMethod(operationName = "BearerTokenLogon", action = "xtk:session#BearerTokenLogon")
    @RequestWrapper(localName = "BearerTokenLogon", targetNamespace = "urn:xtk:session", className = "xtk.session.BearerTokenLogon")
    @ResponseWrapper(localName = "BearerTokenLogonResponse", targetNamespace = "urn:xtk:session", className = "xtk.session.BearerTokenLogonResponse")
    public void bearerTokenLogon(
        @WebParam(name = "sessiontoken", targetNamespace = "urn:xtk:session")
        String sessiontoken,
        @WebParam(name = "strBearerToken", targetNamespace = "urn:xtk:session")
     ...
     *     returns java.lang.String
     */
    @WebMethod(operationName = "HashPassword", action = "xtk:session#HashPassword")
    @WebResult(name = "pstrEncrypted", targetNamespace = "urn:xtk:session")
    @RequestWrapper(localName = "HashPassword", targetNamespace = "urn:xtk:session", className = "xtk.session.HashPassword")
    @ResponseWrapper(localName = "HashPasswordResponse", targetNamespace = "urn:xtk:session", className = "xtk.session.HashPasswordResponse")
